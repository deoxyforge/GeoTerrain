...
export default function ConfirmDeleteCoordinateDialog({
  open,
  pointNumber,
  onConfirm,
  onCancel,
      ...
      <div className="bg-surface-1 border border-border rounded-xl shadow-2xl w-full max-w-sm mx-4">
        <div className="px-6 py-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-sm font-semibold text-text-primary">Delete Coordinate</h2>
          </div>
          <p className="text-sm text-text-secondary leading-relaxed">
            Are you sure you want to delete{' '}
            <span className="text-text-primary font-medium">Point #{pointNumber}</span>? This action
            cannot be undone and will re-index all subsequent points.
          </p>
        </div>
